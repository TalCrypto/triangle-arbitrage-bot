...
const egV3SwapLog = {
    ...
    topics: [
        ...
        '0x000000000000000000000000c53d01d0634b41eb86b649f1b9d95a2d5119dcfe',
        '0x000000000000000000000000c53d01d0634b41eb86b649f1b9d95a2d5119dcfe',
    ],
...
test('V2 Sync event log decoding test', () => {
    ...
    const evt = iface.decodeEventLog(
        'Sync',
        egV2SyncLog.data,
        egV2SyncLog.topics
    );
...
test('V3 Swap event log decoding test', () => {
    ...
    expect(evt.sqrtPriceX96.toString()).toEqual(
        '79222820741311993859916520366'
    );
